...
public class RoomController {
  ...
  public ResponseEntity<String> getPlayers() {
    ...
    response.append(
        "</table>Bet amount: <input type=\"text\" name=\"betAmount\" value=\"10\"><input type=\"submit\" value=\"Record Game\" style=\"margin-left:8px;margin-top:8px;background:#00FF00\"></form><form action=\"/resetSession\" method=\"GET\"><input type=\"submit\" value=\"Reset Session\" style=\"margin-left:8px;margin-top:8px;background:#FF0000\"></form></font></body></html>");
